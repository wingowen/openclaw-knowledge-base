...
## 📊 股票观察池（2026-03-18 扩容至10只）

**位置**: `daily_stock_analysis/STOCK_POOL.md`（池子管理文档）
**配置**: `daily_stock_analysis/.env` → `STOCK_LIST=600036,002142,601899,600362,601318,600309,600938,601225,601919,600585`

**当前池子**:
- 🏦 银行：招商银行(600036)、宁波银行(002142)
- ⛏️ 有色：紫金矿业(601899)、江西铜业(600362)
- 🛡️ 保险：中国平安(601318)
- 🧪 化工：万华化学(600309) — MDI龙头，PE 20
- ⛽ 油气：中国海油(600938) — 低成本+高股息
- 🔥 煤炭：陕西煤业(601225) — PE 15，高分红
- 🚢 航运：中远海控(601919) — PE 6.5，深度低估
- 🏗️ 水泥：海螺水泥(600585) — PB 0.69，破净

**管理规则**:
- 每日收盘检查剔除条件
- 每周五全面审视（已加入 HEARTBEAT）
- 每月初回顾上月表现
- 候选列表：中海油服、恒力石化、中国铁建/中铁、潍柴动力

**GitHub Actions**: daily_stock_analysis 的 Actions workflow 会自动使用 STOCK_LIST 跑每日分析。
